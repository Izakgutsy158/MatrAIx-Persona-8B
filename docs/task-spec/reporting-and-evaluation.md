...
See [README.md](../../application/task-spec/README.md) **Step 4** for the onboarding version; this is the full
reference.
...
|---|---|---|
| Survey | [`survey/survey_reporting.example.json`](../../application/task-spec/survey/survey_reporting.example.json) | per-question contexts; persona layer usually N/A |
| Chatbot | [`chatbot/chatbot_reporting.example.json`](../../application/task-spec/chatbot/chatbot_reporting.example.json) | baseline covers outcome + conversation + feedback |
| Web | [`web/web_metric_reporting.example.json`](../../application/task-spec/web/web_metric_reporting.example.json), [`web/persona_sensitive_reporting.example.json`](../../application/task-spec/web/persona_sensitive_reporting.example.json) | merge `contextRules[]` for both lenses |
| OS / app | [`os-app/os_app_metric_reporting.example.json`](../../application/task-spec/os-app/os_app_metric_reporting.example.json), [`os-app/os_app_persona_reporting.example.json`](../../application/task-spec/os-app/os_app_persona_reporting.example.json) | merge `contextRules[]` for both lenses |
