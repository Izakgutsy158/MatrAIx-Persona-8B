...
[`README.md`](../../application/task-spec/chatbot/README.md) reporting contract.
...
[`README.md`](../../application/task-spec/chatbot/README.md) (`contexts[]`, `facets[]`, `taskType: "chatbot"`).
Typical contents:
