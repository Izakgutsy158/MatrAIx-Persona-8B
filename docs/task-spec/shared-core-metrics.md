...
channel. Read [README.md](../../application/task-spec/README.md) **Step 1** (web vs os-app) and **Step 3**
...
[`web/README.md`](../../application/task-spec/web/README.md) and [`os-app/README.md`](../../application/task-spec/os-app/README.md).
